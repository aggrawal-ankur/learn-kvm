...
/*
 * Bit 0 to 15 of `kvm_userspace_memory_region::flags` 
 * are visible for userspace, other bits are reserved 
 * for kvm internal use which are defined in 
...
/* [?] What is the purpose of these defintions? */
...
/*
 * Check if a kvm extension is available.
 * Argument is extension number, return is 1 (yes), 
 * or 0 (no, sorry).
 */
